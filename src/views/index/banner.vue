 ...
 * @LastEditors: chenjia
 * @LastEditTime: 2019-10-10 16:26:15
 -->
<template>
 <!-- 轮播图 -->
    <div class="bgbanner">
      <van-swipe :autoplay="3000" :loop="true" indicator-color="#fff" style="eheight: 260px;width: 90%" class="banner" >
...
.bgbanner{
    background: #f5f5f5 url(/img/top_bg.19522e98.png);
